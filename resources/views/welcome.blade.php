    ...
    <main class="flex-shrink-0">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container px-5">
                <a class="navbar-brand" href="{{ url('/') }}"><i class="fa fa-home"></i> <span style="color: #34ebff;">Rentex </span>Bolivia </a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="nav-link" href="{{ url('/') }}">Inicio</a></li>
                        <li class="nav-item"><a class="nav-link" href="about.html">Inmuebles</a></li>
                            ...
                            <div class="inner-intro">
                                <section class="tour section-wrapper container">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="form-floating col-md-3 col-sm-6">
                                            ...
                                            <select class="form-control border-radius" laceholder="introduzca su usuario" id="sel1">
                                        ...
                                        <div class="form-floating col-md-3 col-sm-6">
                                        <a class="btn btn-primary btn-lg px-2 me-sm-3" href="#features">Get Started</a>
    ...
    <footer class="bg-dark py-4 mt-auto">
        <div class="container px-5">
            <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                <div class="col-auto">
                    <div class="small m-0 text-white">Copyright &copy; Rentex Bolivia</div>
                </div>
                <div class="col-auto">
